...
exports.default = {
	...
	methods: {
		resizeInput: function resizeInput() {
			...
			var height = Math.floor(textarea.getBoundingClientRect().height);
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: {
        empty: _vm.value === "",
        "show-label": _vm.focused && _vm.value !== "",
        "has-error": _vm.displayError !== "",
        focused: _vm.focused
      }
    },
    [
      ...
      _c("div", { staticClass: "text-wrapper" }, [
        _c("textarea", {
          ...
          ref: "textarea",
          class: _vm.options.classList,
          attrs: { placeholder: _vm.options.placeholder },
